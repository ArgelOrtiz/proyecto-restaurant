  ...
  <div>
    ...
    <section class="probootstrap-cta probootstrap-light">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <a @click="$refs.modal.open('modal')" href="#" class="btn btn-primary">Nuevo postre</a>
          </div>
        </div>
      </div>
    </section>
    <sweet-modal ref="modal" overlay-theme="dark" title="Nuevo postre">
      <div class="form-row">
      ...
      <div class="form-group">
        <label for="descripcion-platillo">Descripción del postre</label>
        <textarea
    ...
    <sweet-modal ref="modal_edicion" overlay-theme="dark" title="Edicion de postre">
      <div class="form-row">
        <div class="form-group col-md-8">
      ...
      <div class="form-group">
        <label for="descripcion-platillo_edit">Descripción del postre</label>
        <textarea
